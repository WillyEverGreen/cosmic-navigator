...
const FinalCTA = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center py-20 md:py-32 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse at center bottom, hsl(230 50% 15%) 0%, hsl(230 60% 6%) 60%, hsl(235 50% 4%) 100%)',
          }}
        />

        {/* Distant galaxy */}
        <div 
          className="absolute top-1/4 right-1/4 w-64 h-64 opacity-30 blur-3xl"
          style={{
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <div className="relative w-24 h-40 md:w-32 md:h-52">
                {/* Main body */}
                <div 
                  className="absolute inset-x-4 top-0 bottom-8 rounded-t-full"
                  style={{
                    background: 'linear-gradient(180deg, hsl(210 40% 96%) 0%, hsl(210 30% 85%) 100%)',
                    boxShadow: 'inset -5px 0 10px rgba(0,0,0,0.2), inset 5px 0 10px rgba(255,255,255,0.3)',
                  }}
                />
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-1/4 w-6 h-6 md:w-8 md:h-8 rounded-full bg-cosmic-glow border-2 border-star-white/80">
                  <div className="absolute inset-1 rounded-full bg-gradient-to-br from-cosmic-glow to-cosmic-purple" />
                </div>
                ...
                <motion.div 
                  ...
                  animate={isLaunching ? { scaleY: [1, 3, 1], opacity: [0.8, 1, 0.8] } : { scaleY: [1, 1.2, 1], opacity: [0.6, 0.8, 0.6] }}
                  transition={{ duration: isLaunching ? 0.2 : 0.8, repeat: Infinity }}
                >
                  <div 
                    className="w-full h-full"
                    style={{
                      background: 'linear-gradient(180deg, hsl(45 93% 58%) 0%, hsl(25 95% 53%) 50%, transparent 100%)',
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto mb-10">
              Join thousands of explorers tracking the cosmos in real-time. Your journey through space starts here.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <Rocket className={`w-5 h-5 mr-2 transition-transform ${isLaunching ? 'animate-bounce' : 'group-hover:-translate-y-1'}`} />
                Start Tracking
                <Sparkles className="w-4 h-4 ml-2 opacity-0 group-hover:opacity-100 transition-opacity" />
              </motion.button>

              <button className="btn-ghost-cosmic text-lg py-5 px-10">
