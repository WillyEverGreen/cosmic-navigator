...
import { Telescope, Menu, X, Download } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="flex items-center gap-2 group">
              <div className="w-10 h-10 rounded-xl bg-gradient-cosmic flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            <div className="hidden md:block">
              <button className="btn-cosmic py-2.5 px-6 text-sm">
      ...
      {/* Floating Download Button (appears after scroll) */}
      <AnimatePresence>
        {isScrolled && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <button className="btn-cosmic py-3 px-5 text-sm shadow-2xl">
              <Download className="w-4 h-4 mr-2" />
              Get App
            </button>
          </motion.div>
