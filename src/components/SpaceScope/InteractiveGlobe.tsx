...
const regions: Region[] = [
  { id: 'na', name: 'North America', visibility: 95, localTime: '11:30 PM - 3:00 AM', direction: 'Northeast', status: 'visible' },
  { id: 'eu', name: 'Europe', visibility: 78, localTime: '4:30 AM - 6:00 AM', direction: 'Northwest', status: 'partial' },
  { id: 'asia', name: 'Asia', visibility: 45, localTime: '8:30 PM - 10:00 PM', direction: 'North', status: 'partial' },
  { id: 'sa', name: 'South America', visibility: 88, localTime: '10:00 PM - 2:00 AM', direction: 'East', status: 'visible' },
];
...
const InteractiveGlobe = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-screen py-20 md:py-32 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-cosmic-glow/5 to-transparent" />
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cosmic-glow/10 border border-cosmic-glow/20 mb-4">
            ...
            <span className="text-sm text-cosmic-glow font-medium">Personalized Tracking</span>
          </div>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Every location sees space differently. SpaceScope adapts to your position on Earth.
          </p>
        </motion.div>
            ...
            <div 
              ...
              style={{
                ...
                boxShadow: `
                  ...
                  inset 10px 10px 40px rgba(99, 102, 241, 0.2),
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
              ...
              {[0.2, 0.35, 0.5, 0.65, 0.8].map((ratio, i) => (
                <ellipse
                  ...
                  cx="200"
                  cy={200}
                  rx={180 * Math.sin(Math.acos(ratio - 0.5) * 2)}
                  ry={(180 * Math.sin(Math.acos(ratio - 0.5) * 2)) * 0.3}
                  fill="none"
                  ...
                  <div className="relative">
                    <motion.div
                      animate={{ 
                        ...
                        boxShadow: isHovering === region.id 
                ...
                <>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex items-center gap-4 p-3 rounded-xl bg-muted/50">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">Best viewing time</p>
                        <p className="text-star-white font-medium">{selectedRegion.localTime}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-3 rounded-xl bg-muted/50">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">Look towards</p>
                        <p className="text-star-white font-medium">{selectedRegion.direction}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-3 rounded-xl bg-muted/50">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">Event visibility</p>
